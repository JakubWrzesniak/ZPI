...
final class MultiShardQuerySample {
    ...
    static void executeMultiShardQuery(RangeShardMap<Integer> shardMap,
        ...
        try (MultiShardConnection conn = new MultiShardConnection(credentialsConnectionString, shards.toArray(new Shard[shards.size()]))) {
            ...
            try (MultiShardStatement cmd = conn.createCommand()) {
                ...
                try (MultiShardResultSet resultSet = cmd.executeQuery()) {
                    ...
                    if (resultSet.next()) {
                        ...
                        TableFormatter formatter = new TableFormatter(columnNames.toArray(new String[columnNames.size()]));
                        ...
                        do {
                            ...
                            String[] values = new String[] {Integer.toString(customerId), customerName, Integer.toString(orderId), location};
