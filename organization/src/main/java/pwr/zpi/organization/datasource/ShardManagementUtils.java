...
import static pwr.zpi.organization.datasource.SqlDatabaseUtils.*;

@Log4j2
public class ShardManagementUtils {
    ...
    public static boolean provisionNewTenant(String databaseName, Boolean isGlobal, UUID databaseKey) {
        ...
        Shard shard = ShardManagementUtils.createOrGetShard(shardMap, shardLocation);
