...
public final class SqlConnectionStringBuilder {
    ...
    public String toString() {
        ...
        return "jdbc:sqlserver://" + dataSource + databaseName + user + pass + appName + timeout + integratedSecurity + persistSecurityInfo + "encrypt=false;trustServerCertificate=true;"; //TODO REMOVE IT ASAP
    }
